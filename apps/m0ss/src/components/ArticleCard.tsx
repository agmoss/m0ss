...
import { Button, Card, CardActions, CardContent, Typography, Box, Chip, CardHeader, Avatar } from "@mui/material"
...
const CategoryChip = styled(Chip)(({ theme, color }) => ({
  ...
  color: color === "primary" || color === "secondary" ? theme.palette.common.white : theme.palette.text.primary,
}))
  ...
  return (
    <Root variant="outlined">
      <CardHeader
        ...
        subheader={<CategoryChip label={category.name} size="small" color={category.color} />}
      />
      <CardContentStyled>
